...
# ═══════════════════════════════════════════════
# 2026 KERALA IT ROLES — Updated & Expanded
# ═══════════════════════════════════════════════

ROLE_SKILLS = {
    # Original roles — updated for 2026
    "Data Scientist": [
    ...
    # 2026 Hot roles — Kerala IT market
    "Prompt Engineer": [
    ...
    # Kerala specific — Technopark/Infopark/Cyberpark jobs
...
# ═══════════════════════════════════════════════
# LEARNING RESOURCES — free, India-specific
# ═══════════════════════════════════════════════
...
def get_learning_resources(missing_skills: List[str]) -> List[dict]:
    ...
    resources_map = {
        ...
        "pytorch": {"platform": "PyTorch Official Docs", "url": "https://pytorch.org/tutorials", "type": "Free"},
    ...
    for skill in missing_skills[:3]:
        # Top 3 missing skills resources
...
def analyse_skills(data: SkillGapRequest):
    ...
    # Get Kerala companies for this role
...
@router.get("/roles")
def get_all_roles():
    # Return all available roles with skill count
    return {
...
def get_role_details(role_name: str):
    # Return skills required for a specific role
