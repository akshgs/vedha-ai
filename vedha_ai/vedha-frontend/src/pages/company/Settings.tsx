      ...
      <div className="mx-auto max-w-4xl space-y-6 font-sans">
        <div>
          ...
          <p className="mt-2 text-slate-400">
            Configure your corporate notifications and credentials.
          </p>
        </div>
          ...
          <div className="rounded-2xl border border-slate-800 bg-slate-900/60 p-6 shadow-xl backdrop-blur-sm flex flex-col justify-between">
            <div>
              <div className="flex items-center gap-3 border-b border-slate-800 pb-3 mb-6">
                <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-emerald-500/10 text-emerald-400 border border-emerald-500/15 flex-shrink-0">
                  <Bell size={18} />
                </div>
                <div>
              ...
              <div className="space-y-5">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs text-slate-400">Receive candidate application updates & interviews alerts</p>
                  </div>
                  <button
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs text-slate-400">Get instant candidate message reminders</p>
                  </div>
                  <button
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <h3 className="text-sm font-semibold text-white">Weekly Recruitment Digest</h3>
                    <p className="text-xs text-slate-400">Summary of applicants statistics & matched resumes</p>
                  </div>
                  <button
                    onClick={() => setWeeklyDigest(!weeklyDigest)}
                    className={`relative inline-flex h-6 w-11 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none ${
                      weeklyDigest ? "bg-emerald-500" : "bg-slate-700"
                    }`}
                  >
                    <span
                      className={`pointer-events-none inline-block h-5 w-5 transform rounded-full bg-white shadow ring-0 transition duration-200 ease-in-out ${
          ...
          <div className="rounded-2xl border border-slate-800 bg-slate-900/60 p-6 shadow-xl backdrop-blur-sm">
            <div className="flex items-center gap-3 border-b border-slate-800 pb-3 mb-6">
              ...
              <div>
                ...
                <p className="text-[10px] text-slate-500">Secure your portal account</p>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit(handlePasswordChange)} className="space-y-4">
              ...
              <div className="pt-2 flex justify-end">
                <Button type="submit" disabled={isSubmitting} className="flex items-center gap-2 bg-emerald-600 hover:bg-emerald-500">
                  {isSubmitting ? (
