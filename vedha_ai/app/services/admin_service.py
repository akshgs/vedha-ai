...
class AdminService:
    ...
    def get_dashboard(self) -> AdminDashboardResponse:
        return AdminDashboardResponse(
            ...
            total_employees=self.admin_repository.get_total_employees(),
            total_courses=self.admin_repository.get_total_courses(),
            ...
            total_offers=self.admin_repository.get_total_offers(),
            total_active_users=self.admin_repository.get_total_active_users(),
            learning_progress_avg=round(self.admin_repository.get_learning_progress_avg(), 2),
            job_statistics=self.admin_repository.get_job_statistics(),
            active_users_trend=self.admin_repository.get_active_users_trend(),
        )
